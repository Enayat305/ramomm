                            ...
                            <div class="tab-pane active">
                                ...
                                <?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered validate')); ?>
                                    <div class="form-group">
                                        <label for="username" class="col-md-3 control-label">Envato Username</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="purchase_username" value="<?=set_value('purchase_username')?>" autocomplete="on" />
